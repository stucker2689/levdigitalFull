    ...
    doInit : function(component, event, helper){
        ...
        if(parsedRecord.hasOwnProperty('Owner')){
            if(parsedRecord.Owner["Name"] == 'Lev - HelpDesk'){
                ownerColor = '#b2beb5';
            }else if(parsedRecord.Owner["Name"] == 'Samuel Tucker'){
                //ownerColor = '#FF9200';
                ownerColor = '#c4dbff';
            }
            ...
            if(parsedRecord.hasOwnProperty('SprintWeeks')){
                ...
                if(parsedRecord.SprintWeeks){
                    ...
                    if(hasOctFourth && hasOctEleventh ){
                        sprintWeeksList = helper.moveItemInArray(sprintWeeksList, sprintWeeksList.length - 1, indexOFEleventh);
                    }
                ...
                if(parsedRecord.hasOwnProperty('Status')){
                    if(parsedRecord.Status == 'In Process'){
                        ...
                        if(parsedRecord.QaStatus == 'Work in Progress'){
                            ...
                            component.set('v.QaStatusColor', 'rgb(211, 144, 0)');
